...
const out = { generatedAt: new Date().toISOString(), horizonDays: HORIZON, threshold: THRESHOLD, hills: {} };
...
console.log(`\nwrote ${OUT} — ${ok}/${Object.keys(resorts).length} hills, ${HORIZON}-day horizon`);
